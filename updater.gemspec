...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.markdown", "Rakefile", "VERSION", "lib/updater.rb", "lib/updater", "lib/updater/setup.rb", "lib/updater/util.rb", "lib/updater/chained.rb", "lib/updater/update.rb", "lib/updater/fork_worker.rb", "lib/updater/target.rb", "lib/updater/tasks.rb", "lib/updater/thread_worker.rb", "lib/updater/orm", "lib/updater/orm/orm.rb", "lib/updater/orm/datamapper.rb", "lib/updater/orm/mock.rb", "lib/updater/orm/activerocord.rb", "lib/updater/orm/mongo.rb", "spec/results.html", "spec/datamapper_orm_spec.rb", "spec/fork_worker_instance_spec.rb", "spec/thread_worker_spec.rb", "spec/schedule_spec.rb", "spec/mock_orm_spec.rb", "spec/params_sub_spec.rb", "spec/chained_spec.rb", "spec/fooclass_spec.rb", "spec/fooclass.rb", "spec/update_spec.rb", "spec/mongo_orm_spec.rb", "spec/orm_lint.rb", "spec/spec_helper.rb", "spec/named_request_spec.rb", "spec/update_runner_spec.rb", "spec/util_spec.rb", "spec/target_spec.rb", "spec/fork_worker_spec.rb", "spec/chained_class_spec.rb", "spec/errors_spec.rb", "bin/updater"]
